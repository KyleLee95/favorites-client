package favorites.presentation.screens.details
...
import favorites.presentation.components.YelpMap
...
fun convertMilitaryTo12HourTime(militaryTime: String): String {
    ...
    val hours = militaryTime.substring(0, 2).toInt()
    val minutes = militaryTime.substring(2, 4)
    ...
    return String.format("%02d:%s %s", twelveHour, minutes, period)
}
...
fun DetailsPreview() {
    ...
    DetailsScreen(businessViewModel = businessViewModel, navController = rememberNavController())
}
