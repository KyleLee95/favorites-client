package favorites.presentation.screens
...
fun SearchScreen(
    ...
    val queryText = businessViewModel.queryText.value
    val locationText = businessViewModel.locationText.value
    ...
    Scaffold(
        ...
        Column(
            ...
            CustomOutlinedTextField(
                title = "Search term(s)",
                placeHolder = "e.g. Sushi or Plumbers",
                textState = queryText,
                onTextChange = businessViewModel::setQueryText,
            ...
            CustomOutlinedTextField(
                ...
                onTextChange = businessViewModel::setLocationText,
                keyboardType = KeyboardType.Text,
                ImeAction.Search,
                businessViewModel::onSearch
            )
